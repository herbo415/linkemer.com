...
Line 33:3 Transforming let to the configured target environment ("es5") is not supported yet
Line 34:3 Transforming let to the configured target environment ("es5") is not supported yet
Line 35:3 Transforming let to the configured target environment ("es5") is not supported yet
Line 59:3 Transforming let to the configured target environment ("es5") is not supported yet
